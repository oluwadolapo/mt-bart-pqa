...
def get_params():
    ...
    parser.add_argument('--load_classifier_path', dest='load_classifier_path', type=str, default=None,
                        help='classifier Path if not training from scratch')
    ...
    parser.add_argument('--generator_data_path', dest='generator_data_path', type=str, default=None,
                        help='Answer generation Dataset Path')
    parser.add_argument('--verifier_data_path', dest='verifier_data_path', type=str, default=None,
                        help='Answer verification Dataset Path')
    ...
    parser.add_argument('--exp_type', dest='exp_type', type=str, default=None,
                        help='Category of experiment to run: "train", "test_classifier", "test_generator"')
    # Evaluation
    parser.add_argument('--output_json_path', dest='output_json_path', type=str, default='output_bart.json',
